// ==UserScript==
// @name        ISOing user's posts Outer Mafia
...
const elmEnds = document.getElementsByClassName("p-breadcrumbs"); //breadcrumb p-breadcrumb--bottom
...
const elmEndBottoms = document.getElementsByClassName("p-breadcrumbs p-breadcrumbs--bottom"); //breadcrumb p-breadcrumb--bottom
